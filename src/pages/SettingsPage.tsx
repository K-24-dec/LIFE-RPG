      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        ...
        <div className="bg-[#0d1322] border border-cyan-500/20 rounded-3xl p-6 shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-black text-white">CHARACTER SETTINGS</h1>
        ...
        <div className="bg-[#0d1322] border border-cyan-500/20 rounded-3xl p-6 shadow-lg space-y-4">
          ...
          <form onSubmit={handleSaveName} className="space-y-4 text-xs">
            <div>
              <label className="block text-slate-300 font-bold mb-1">HERO DISPLAY NAME</label>
              <input
                type="text"
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="w-full bg-[#080c14] border border-slate-700 focus:border-cyan-400 rounded-xl px-4 py-2.5 text-white font-mono"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="px-5 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-[#080c14] font-bold flex items-center gap-2 shadow-[0_0_15px_rgba(0,240,255,0.3)]"
            >
        ...
        <div className="bg-[#0d1322] border border-rose-500/30 rounded-3xl p-6 shadow-lg space-y-4">
          ...
          <button
            onClick={handleReset}
            className="px-5 py-2.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/40 text-rose-300 font-bold text-xs flex items-center gap-2 transition"
          >
